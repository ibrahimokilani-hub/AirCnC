        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_RoomTypes_MaxAdults", "[MaxAdults] >= 1");
                    table.CheckConstraint("CK_RoomTypes_MaxChildren", "[MaxChildren] >= 0");
                    table.CheckConstraint("CK_RoomTypes_PricePerNight", "[PricePerNight] > 0");
                    table.ForeignKey(
